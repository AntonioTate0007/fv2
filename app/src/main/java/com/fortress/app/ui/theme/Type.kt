...
val FortressTypography = Typography(
    displayLarge = TextStyle(fontFamily = sans, fontWeight = FontWeight.Black, fontSize = 40.sp, lineHeight = 44.sp),
    ...
    labelLarge = TextStyle(fontFamily = sans, fontWeight = FontWeight.Bold, fontSize = 14.sp, lineHeight = 18.sp, letterSpacing = 1.sp),
